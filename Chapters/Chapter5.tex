...
\end{equation}
The Structrural Similarity Index SSIM 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\textbf{Hardware:} For all our experiments we used \textit{Nvidia Quadro RTX 8000} graphic card with Graphics processor memory 48 GB GDDR6 with ECCRTX-OPS 84T on Linux operating system with Ubuntu distribution . \nadacn{write about power consumption}.\\ 
