...
\end{figure}
 ...
 \section{Influence Of Transfer Learning by different Cameras properties }
 \label{Chapter6:Transfer_Learning}
 In this section, we wanted to investigate if different cameras intrinsic and extrinsic properties can influence the results on Structural sensor. For this our input representation is with depth containing holes. \textbf{E3} was performed by training the decoder with 120,000 images of NYU\_v2 dataset and  1499 images of Structure Dataset. In \textbf{E4} we only used Structure dataset of 1499 images with no data augmentation. 
...
As we notice in output of the two different configuration in Figure \ref{fig:results_E3_E4}. The There is a significance differrence in the two preodicted 
