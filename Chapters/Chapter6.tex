...
\newpage
 ...
 \begin{figure}[h]
\centering
    \includegraphics[width = 15cm]{Figures/results/3D/3D.png} 
    \caption{3D visualization of depth image: (a) output of \textbf{E5 A2\_Holes} and (b)output of  \textbf{E5 A2\_NoHoles}}
    \label{fig:3drecon}
\end{figure}
...
This leads us to an conclusion that for 3D reconstruction task, interpolating of pixel is a better approach than making than network learn to predict holes because of intermediate pixel effect. But on the other hand for for etimation of depth of a frame level for distance measurement both the approach 
...
\textbf{\#} & \textbf{Model} & \multicolumn{3}{l}{\textbf{Accuracy}} & \multicolumn{2}{l}{\textbf{Error}} \\ \cline{3-7} 
                    &                        & a1       & a2       & a3      & RMSE         & log\_10      \\ \hline
\multicolumn{7}{l}{\texttt{Base Line}}                                            \\ \hline
\textbf{AL}                  & \textbf{A2}  &  0.89      & 0.98 & 0.99       &   0.39          &0.043              \\ \hline
\textbf{Our}                  &  \textbf{A1}  & 0.39         & 0.65          &  0.82       & 0.23            &   0.16           \\ \hline


\end{tabular}

\caption{Comparism with state of the art}
