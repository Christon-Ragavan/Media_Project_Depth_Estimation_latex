...
\end{figure}
 ...
 In this section, we wanted to investigate if different cameras intrinsic and extrinsic properties can influence the results on Structural sensor. One approach is 
